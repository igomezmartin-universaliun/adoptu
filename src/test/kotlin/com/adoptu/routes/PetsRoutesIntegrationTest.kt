...
class PetsRoutesIntegrationTest {
    ...
    fun setup() {
        ...
        val photographerService = com.adoptu.services.PhotographerService(photographerRepository, null, userRepository, clock)
    ...
    fun `PUT sets primary image`() {
        ...
        // Add two images
        petService.addImage(created.id, 1, setOf("RESCUER"), "https://s3.example.com/image1.jpg", false)
        val img2 = (petService.addImage(created.id, 1, setOf("RESCUER"), "https://s3.example.com/image2.jpg", false) as ServiceResult.Success).data
    ...
    private fun createPetViaRepository(
        ...
        return PetRepositoryImpl(clock).create(
            rescuerId = rescuerId,
            name = name,
            type = type,
