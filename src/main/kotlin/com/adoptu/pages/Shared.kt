    ...
    div(classes = "nav-right") {
        ...
        div(classes = "user-menu") {
            ...
            div(classes = "user-dropdown") { id = "user-dropdown"; style = "display:none"
                ...
                a("/temporal-home") { id = "dropdown-temporal-home"; style = "display:none";
                ...
                a("/admin") { id = "dropdown-admin"; style = "display:none";
                ...
                a("/admin/shelters") { id = "dropdown-admin-shelters"; style = "display:none";
