...
class UserShelterService(private val repository: UserShelterRepositoryPort) {
    ...
    fun getByUserId(userId: Int): UserShelterDto? = repository.getByUserId(userId)
    ...
    fun update(userId: Int, request: UpdateUserShelterRequest): ServiceResult<UserShelterDto> {
    ...
    fun search(country: String, state: String? = null, city: String? = null, neighborhood: String? = null, zip: String? = null): List<UserShelterDto> {
