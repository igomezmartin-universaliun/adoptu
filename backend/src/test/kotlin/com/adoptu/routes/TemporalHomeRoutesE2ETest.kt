    ...
    fun `POST temporal-home returns 401 when no session`() {
        testApplication {
            ...
            val response = client.post("/api/users/temporal-home") {
                contentType(ContentType.Application.Json)
                setBody(Json.encodeToString(CreateTemporalHomeRequest.serializer(), CreateTemporalHomeRequest("My Home", "US", city = "Dallas")))
            }
    ...
    fun `POST temporal-home returns 400 when profile already exists`() {
        testApplication {
            ...
            val response = client.post("/api/users/temporal-home") {
                ...
                contentType(ContentType.Application.Json)
                setBody(Json.encodeToString(CreateTemporalHomeRequest.serializer(), CreateTemporalHomeRequest("Another Home", "US", city = "Dallas")))
            }
    ...
    fun `POST temporal-home returns 400 when alias is blank`() {
        testApplication {
            ...
            val response = client.post("/api/users/temporal-home") {
                header(HttpHeaders.Cookie, cookie)
                contentType(ContentType.Application.Json)
                setBody(Json.encodeToString(CreateTemporalHomeRequest.serializer(), CreateTemporalHomeRequest("", "US", city = "Dallas")))
            }
            assertEquals(HttpStatusCode.BadRequest, response.status)
    ...
    fun `POST temporal-home creates a new profile`() {
        testApplication {
            ...
            val response = client.post("/api/users/temporal-home") {
                header(HttpHeaders.Cookie, cookie)
                contentType(ContentType.Application.Json)
                setBody(Json.encodeToString(CreateTemporalHomeRequest.serializer(), CreateTemporalHomeRequest("Sunny Home", "US", city = "Dallas")))
            }
    ...
    fun `PUT temporal-home updates the profile when it exists`() {
        testApplication {
            ...
            val response = client.put("/api/users/temporal-home") {
                header(HttpHeaders.Cookie, cookie)
                contentType(ContentType.Application.Json)
                setBody(Json.encodeToString(UpdateTemporalHomeRequest.serializer(), UpdateTemporalHomeRequest(alias = "Updated Cozy Home")))
            }
            assertEquals(HttpStatusCode.OK, response.status)
