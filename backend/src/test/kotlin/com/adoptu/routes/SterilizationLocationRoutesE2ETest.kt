...
class SterilizationLocationRoutesE2ETest {
    ...
    private fun createLocationInDb(
        ...
        return transaction {
            ...
            SterilizationLocations.insert {
                ...
                it[SterilizationLocations.country] = country
    ...
    fun `GET sterilization-locations returns all locations without filters`() {
        createLocationInDb(name = "Clinic A", country = "USA")
    ...
    fun `GET sterilization-locations filters by country`() {
        ...
        testApplication {
            setupApp()
            val response = client.get("/api/sterilization-locations?country=USA")
            assertEquals(HttpStatusCode.OK, response.status)
            val body = response.bodyAsText()
            assertTrue(body.contains("Clinic A"))
            assertTrue(!body.contains("Clinic B"))
    ...
    fun `GET sterilization-locations grouped returns grouped structure`() {
        createLocationInDb(name = "Clinic A", country = "USA", state = "CA", city = "LA")
    ...
    fun `GET sterilization-locations states returns states for country`() {
        createLocationInDb(name = "Clinic A", country = "USA", state = "CA")
        createLocationInDb(name = "Clinic B", country = "USA", state = "NY")

        testApplication {
            setupApp()
            val response = client.get("/api/sterilization-locations/countries/USA/states")
            assertEquals(HttpStatusCode.OK, response.status)
            val body = response.bodyAsText()
    ...
    fun `GET sterilization-locations cities returns cities for country and state`() {
        createLocationInDb(name = "Clinic A", country = "USA", state = "CA", city = "LA")
        createLocationInDb(name = "Clinic B", country = "USA", state = "CA", city = "SF")

        testApplication {
            setupApp()
            val response = client.get("/api/sterilization-locations/countries/USA/states/CA/cities")
            assertEquals(HttpStatusCode.OK, response.status)
            val body = response.bodyAsText()
    ...
    fun `GET admin sterilization-locations filters by country`() {
        ...
        testApplication {
            setupApp()
            val response = client.get("/api/admin/sterilization-locations?country=USA")
            assertEquals(HttpStatusCode.OK, response.status)
            val body = response.bodyAsText()
            assertTrue(body.contains("Clinic A"))
            assertTrue(!body.contains("Clinic B"))
